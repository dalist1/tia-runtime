...
export const DEFAULT_OVERALL_TIMEOUT_MS = 45000
export const HARD_MAX_OVERALL_TIMEOUT_MS = 180000
...
export const SEARCH_USER_AGENT = process.env.TIA_NATIVE_SEARCH_USER_AGENT ?? 'tia-runtime-native-search/0.1 (+https://github.com/dalist1/tia-runtime; respectful low-rate fetcher)'
...
export function clampInteger(value: number | undefined, fallback: number, min: number, max: number) {
...
export function baseOriginIntervalMs() {
 return envNumber('TIA_NATIVE_SEARCH_ORIGIN_INTERVAL_MS', DEFAULT_ORIGIN_INTERVAL_MS, 0, 60 * 1000)
}
